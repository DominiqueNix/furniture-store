...
public class FurnitureEnum {
    ...
    public enum FurnitureSubType {
        ACCENT_CHAR, DINING_CHAIR, OFFICE_CHAIR, LOVESEAT, SECTIONAL, MODULAR, COFFEE_TABLE, CONSOLE_TABLE, SIDE_TABLE, DINING_TABLE, END_TABLE,  PLATFORM_BED, UNSPECIFED
    }
    ...
    public enum FurnitureStyle {
        MONDERN, MINIMAL, RUSTIC, CONTEMPORARY, INDUSTRIAL, MID_CENTURY_MODERN, TRADITIONAL, SCANDINAVIAN, BOHEMIAN
    }
