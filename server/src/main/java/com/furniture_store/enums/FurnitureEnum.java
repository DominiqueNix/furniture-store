...
public class FurnitureEnum {
    ...
    public enum FurnitureSubType {
        ACCENT_CHAIR, DINING_CHAIR, OFFICE_CHAIR, LOVESEAT, SECTIONAL, MODULAR, COFFEE_TABLE, CONSOLE_TABLE, SIDE_TABLE, DINING_TABLE, END_TABLE,  PLATFORM_BED, UNSPECIFIED
    }
